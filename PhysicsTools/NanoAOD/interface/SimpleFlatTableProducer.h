...
public:
  BXVectorSimpleFlatTableProducer(edm::ParameterSet const &params) : 
	...
	throw cms::Exception("Configuration", "BXVectorSimpleFlatTableProducer already defines the "+bxVarName_ + "internally and thus you should not specify it yourself");
      }
    }
  std::unique_ptr<nanoaod::FlatTable> fillTable(const edm::Event &iEvent,
