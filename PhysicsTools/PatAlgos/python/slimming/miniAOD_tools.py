...
def miniAOD_customizeCommon(process):
    ...
    from RecoEgamma.EgammaTools.egammaObjectModificationsInMiniAOD_cff  import appendReducedEgammaEnergyScaleAndSmearingModifier
    appendReducedEgammaEnergyScaleAndSmearingModifier(egamma_modifications)
