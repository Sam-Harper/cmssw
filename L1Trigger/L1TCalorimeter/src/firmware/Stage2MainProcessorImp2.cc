...
l1t::Stage2MainProcessorFirmwareImp2::Stage2MainProcessorFirmwareImp2(unsigned fwv, CaloParams* params) :
  m_params(params)
{

  m_towerAlgo = new Stage2TowerDecompressAlgorithmFirmwareImp1(m_params);
  m_egClusterAlgo = new Stage2Layer2ClusterAlgorithmFirmwareImp2(m_params,
								 l1t::CaloTools::ECAL);
  m_egAlgo = new Stage2Layer2EGammaAlgorithmFirmwareImp2(m_params);
...
void l1t::Stage2MainProcessorFirmwareImp2::processEvent(const std::vector<l1t::CaloTower> & inTowers,
...
void l1t::Stage2MainProcessorFirmwareImp2::print(std::ostream& out) const {
