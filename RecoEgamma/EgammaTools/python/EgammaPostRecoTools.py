...
_defaultEleIDModules =  [ #'RecoEgamma.ElectronIdentification.Identification.heepElectronID_HEEPV61_cff',
...
def _setupEgammaPostRECOSequence(process,applyEnergyCorrections=False,applyVIDOnCorrectedEgamma=False,era="2017-Nov17ReReco",applyEPCombBug=False):
    ...
    if applyEnergyCorrections:
        ...
        process.egammaScaleSmearSeq = cms.Sequence(process.gedGsfElectrons*
                                                   process.gedPhotons
                                                   )
    else:
        phoCalibSrc = phoSrc
        ...
        process.egammaScaleSmearSeq = cms.Sequence(process.calibratedElectrons*
...
def _setupEgammaPostRECOSequenceMiniAOD(process,applyEnergyCorrections=False,applyVIDOnCorrectedEgamma=False,era="2017-Nov17ReReco",applyEPCombBug=False):
    ...
    process.egammaScaleSmearPreIDSeq = cms.Sequence(process.calibratedPatElectrons*
                                                    process.calibratedPatPhotons)
    process.egammaScaleSmearPostIDSeq = cms.Sequence(process.slimmedElectrons*
...
def setupEgammaPostRecoSeq(process,
    ...
    process.egammaPostRecoSeq   = cms.Sequence(process.egammaScaleSmearPreIDSeq*
                                               ...
                                               process.egammaScaleSmearPostIDSeq)

    #adding the necessary GT overrides for 80X tags
    print "adding ECAL-Trk regression GTs"
    from CondCore.CondDB.CondDB_cfi import CondDB
    CondDB.connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")
    process.egammaTrkRegression = cms.ESSource("PoolDBESSource",CondDB,
                                               toGet = cms.VPSet(
    ...
    process.es_prefer_egammaTrkRegression = cms.ESPrefer("PoolDBESSource","egammaTrkRegression")
