...
#
# The HEEP ID cuts V6.1 is a stop gap fix for 76X
# In 76X, the track isolation is broken above 100 GeV, this leads to a large pileup dependence
# on the HEEP ID efficiency for V6.0
# HEEP V6.1 fixes this by adding a rho correction to the track isolation above 100 GeV
# This ID is only valid for 76X, 74X does not have this problem and HEEP V6.0 should be used
...
idName = "heepElectronID-HEEPV61"
WP_HEEP61_EB = HEEP_WorkingPoint_V2(
    idName=idName,     
    dEtaInSeedCut=0.004,     
    dPhiInCut=0.06,      
    ...
    #     cut = constTerm if value < slopeStart
    #     cut = slopeTerm * (value - slopeStart) + constTerm if value >= slopeStart
    #     if Et > trkIsoRhoCorrStart, the cut value has trkIsoEffArea*rho added to it
    trkIsoSlopeTerm=0.00,     
    trkIsoSlopeStart=0.00,   
    trkIsoConstTerm=5.00,     
    trkIsoRhoCorrStart=95,
    trkIsoEffArea=1.5,
...
WP_HEEP61_EE = HEEP_WorkingPoint_V2(
    idName=idName,     
    dEtaInSeedCut=0.006,     
    dPhiInCut=0.06,      
...
#
heepElectronID_HEEPV61  = configureHEEPElectronID_V61 ( WP_HEEP61_EB, WP_HEEP61_EE )
...
central_id_registry.register(heepElectronID_HEEPV61.idName,"ea8e0a8cd8a62811ee5a53b808519c0b")
heepElectronID_HEEPV61.isPOGApproved = cms.untracked.bool(True)
